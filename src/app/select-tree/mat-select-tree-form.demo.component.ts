...
import { MatSelectTreeField } from "ngx-easyui";

@Component({
    selector: 'mat-select-tree-form-demo',
    template: `
...
export class MatSelectTreeFormComponent {
    ...
    ngAfterViewInit() {
        this.form.form.patchValue({ selectTree: "0" })
